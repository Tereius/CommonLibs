...
if(MSVC)
	...
	find_file(VCVARSALL vcvarsall.bat "${MY_COMPILER_DIR}/.." "${MY_COMPILER_DIR}/../.." "${MY_COMPILER_DIR}/../../../../../../../VC/Auxiliary/Build")
	if(NOT VCVARSALL)
...
if(MSVC)
    ...
    include_and_prepare(mkspecs/win/msvc/QtWebApp_legacy.cmake)
    include_and_prepare(mkspecs/win/msvc/QtService.cmake)
