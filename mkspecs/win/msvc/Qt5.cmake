...
if(Qt5_BUILD_SHARED)
	...
	set(Qt5_OPTIONS "${Qt5_OPTIONS} ZLIB_LIBS=\"-lzlib -L${ZLIB_EXTERNAL_LIB_PATH}\" OPENSSL_LIBS=\"-lssl -lcrypto -L${OpenSSL_EXTERNAL_LIB_PATH}\" -static -L ${OpenSSL_EXTERNAL_LIB_PATH} -I ${OpenSSL_EXTERNAL_INCLUDE_PATH} -L ${zlib_EXTERNAL_LIB_PATH} -I ${zlib_EXTERNAL_INCLUDE_PATH}")
